...
This diagram is inspired by the one in [Penrose's
gallery](https://penrose.cs.cmu.edu/try/?examples=array-models/insertionSort) by
[Vennobennu](https://github.com/penrose/penrose/pull/1716). Created in Bluefish by Elliot Evans.
::: sandbox

```tsx ./App.tsx [active]
import { For, Show } from "solid-js";
import { Arrow, Background, Bluefish, Circle, createName, Group, Rect, Ref, StackH, StackV, withBluefish, Text, Align } from "@bluefish-js/solid";

const unsortedArray = [43, 9, 15, 95, 5, 23, 75];
